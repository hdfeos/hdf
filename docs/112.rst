...
We are pleased to announce the release of the BioHDF pipeline prototype,
built and tested using HDF5-1.8.4 Patch 1 (with the HDF5 1.6 compatibility
flag). This release is intended to demonstrate the capability of HDF5
to store read, alignment, annotation and reference sequence data used in
analyzing next-generation DNA sequencing (NGS) data. It is implemented
...
This release and some sample data can be obtained from the BioHDF web
page at:
...
likely to work with Cygwin. It is available as source code only
(no binaries).
