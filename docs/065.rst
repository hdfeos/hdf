...
. 2nd Beta Release of HDF5 High Level * *
 API Software * Visit the HDF home page *
...
This release includes:
 ...
 o A new "Table API" (H5TB) for manipulating table datasets.
 ...
 o Many new functions for HDF5 Lite (H5L).

 o More examples for the HDF5 Lite (H5L) and HDF5 Image (H5IM) APIs.
