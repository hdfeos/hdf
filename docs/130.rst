...
Newsletter #130 / November 15, 2012
...
HDF 4.2.8 and HDF5-1.8.10 using jdk 1.7.x. It can be obtained from
...
This is a maintenance release with no major changes in functionality.
It includes bug fixes and some minor enhancements.
...
Please note that this is the last release to support 32-bit Mac and
32-bit Solaris. Future releases will not support these two platforms.
