...
-------------------------------------------------------------------------------
 ...
 versa, making it possible to access FITS files with HDF
 software and vice versa. This work has two parts: HDF to
 FITS(HDF2FITS) mapping and FITS to HDF(FITS2HDF) mapping.
 For more information see the "HDF and FITS Conversion Information
 Page", URL:
...
-------------------------------------------------------------------------------
 ...
 compatible with the current HDF and at the same time addresses
