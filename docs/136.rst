...
Important new features and changes in this release include:
   ...
   * Improvements were added to configure for finding other libraries
     used by HDF5.

   * The h5toh4 conversion tool can now convert a fixed-size HDF5
     string in a compound datatype to an HDF4 char type.

Please see the Release file for complete details regarding this
release:
