...
-------------------------------------------------------------------------------
Contribution: HDF-to-DICOMED, HDF-to-postscript, IRIS-to-HDF, and \
IRIS-to-DICOMED
-------------------------------------------------------------------------------
...
that they sent to us.
 ...
 hdftops.c - HDF image to PostScript image conversion utility
  This RCD (Raster Chart Display) utility converts an HDF image
  to either a PostScript program or
  to a PostScript compatilble hex file.
  This conversion will generate programs
  that use the colorimage operator
  (which is not  supported  by  all  PostScript  implementations)
  for 24 bit images and 8 bit images that have a palette.
