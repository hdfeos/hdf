...
Vs2ps produces a PostScript file containing one of the following:
   ...
   #. a contour plot of data defined on a two-dimensional "rectangular" grid
   and/or a line drawing of this grid.  Input data is given in a single
   HDF file.

   #. a contour plot of data defined on a two-dimensional "curvilinear" grid
   ...
   #. a contour plot of data defined on a two-dimensional "finite element"
