...
Newsletter #57 / December 22, 2000
...
fool you). Pre-compiled binaries are not included with this version of
the software.
...
RELEASE file at the top of the HDF5-1.4-Beta2 source code tree.
   ...
   * It includes Fortran 90 support for Solaris 2.6 and 2.7, Linux,
     DEC Unix, Cray T3E, Cray J90 and SGI Origin 2000.

   * It includes the h4toh5 tool for converting HDF (4) files into
     HDF5. This was tested on Solaris 2.5 and 2.6, IRIX 6.5, HP-UX
     11.0, DEC Unix, FreeBSD, and Windows 2000.
...
Release 2.6 of the Java Products is available (as of December 7th).
This release is a bug fix release, built with the HDF 4.1r4 library.
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   ...
   * The Java HDF Interface (JHI) was upgraded and built with the
     ...
     several serious problems with JPEG images, which affected the
     viewer.
