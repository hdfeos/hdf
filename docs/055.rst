...
. New Release of HDF5 Java Products * Visit the HDF home page *

 - H5View: *New Features* * for up-to-date information *
 - h5gen: XML to HDF5 (*New Product*) * *
 - Java HDF5 Interface (JHI5) now * http://hdf.ncsa.uiuc.edu/ *
 uses HDF5-1.2.2 * *

-------------------------------------------------------------------------------

. Revisions to the HDF5 XML Document
 Type Definition (DTD)
