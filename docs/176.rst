...
HDFView version 3.1.2 is now available from the HDFView Download page at https://www.hdfgroup.org/downloads/hdfview/
The software can also be obtained from the HDFView 3.1.2 page on the HDF Support Portal.
...
A bug was fixed with creating and using a dataset with an enum datatype.
