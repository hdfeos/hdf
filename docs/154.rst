...
changes:
   ...
   * It supports 64-bit object identifiers, and uses the HDF-Java
     wrappers that were added to HDF5 (in HDF5-1.10) and HDF4 (in
     HDF 4.2.12).
...
The older HDFView 2.x software supports files created with HDF5-1.8
(or earlier) and any version of HDF4. HDFView 2.x may be able to read
some HDF5-1.10 files if they do not include any new features.
...
Swing GUI framework library was required. This is no longer necessary
in HDFView 3.
